...
//
  ...
  #endif
#else
  // §Patch for static MSS (31-07-2020 Arves100)
  #define DXDEC
  #define DXDEF
#endif
...
#define FN(entry_name)        { RIB_FUNCTION, (char*)#entry_name, (U32) &(entry_name), RIB_NONE }
#define REG_FN(entry_name)    { RIB_FUNCTION, (char*)#entry_name, (U32) &(entry_name), RIB_NONE }

#define RIB_AT(entry_name,ID)             { RIB_ATTRIBUTE, (char*)(entry_name), (U32) &(ID), RIB_NONE } // Fix Python warning !
#define REG_AT(entry_name,ID,subtype) { RIB_ATTRIBUTE, (char*)(entry_name), (U32)  (ID), subtype  }

#define PR(entry_name,ID)             { RIB_PREFERENCE, (char*)(entry_name), (U32) &(ID), RIB_NONE }
#define REG_PR(entry_name,ID,subtype) { RIB_PREFERENCE, (char*)(entry_name), (U32)  (ID), subtype  }
