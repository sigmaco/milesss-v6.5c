...
static F32 calc_dB(F32 linear_min, F32 linear_max, F32 linear_level)
{
...
static void QS_set_volume(SAMPLE3D FAR *S)
{
   if (S->iChannel != QSOUND_INVALID_CHANNEL)
      ...
      qsound_volume = (S32)(vol*32767.0F);
...
static void QS_set_cone(SAMPLE3D FAR *S)
{
   ...
   if (S->iChannel != QSOUND_INVALID_CHANNEL)
      ...
      F32 vol= calc_dB(0.0f,1.0f,S->outer_volume);
...
F32        AILEXPORT M3D_3D_sample_exclusion (H3DSAMPLE samp)
{
   SAMPLE3D FAR *S = (SAMPLE3D FAR *) samp;
...
void       AILEXPORT M3D_set_3D_sample_exclusion(H3DSAMPLE samp, //)
                                                 F32       exclusion)
{
   SAMPLE3D FAR *S = (SAMPLE3D FAR *) samp;
...
void       AILEXPORT M3D_set_3D_sample_volume_level    (H3DSAMPLE samp, //)
                                                        F32       volume)
{
   SAMPLE3D FAR *S = (SAMPLE3D FAR *) samp;
...
F32        AILEXPORT M3D_3D_sample_volume_level        (H3DSAMPLE samp)
{
   SAMPLE3D FAR *S = (SAMPLE3D FAR *) samp;
                                                  ...
                                                  AILSOUNDINFO FAR *info)
{
   ...
   M3D_set_3D_sample_volume_level(samp,
                                  S->volume);
...
//		REG_FN(M3D_3D_sample_cone),
   ...
   const RIB_INTERFACE_ENTRY M3D[] =
      ...
      REG_FN(M3D_set_3D_sample_volume_level),
      ...
      REG_FN(M3D_3D_sample_volume_level),
